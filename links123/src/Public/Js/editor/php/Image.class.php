...
{//类定义开始
     ...
     * @return void
     +----------------------------------------------------------
     */
    static function thumb($image,$thumbname,$type='',$srcX=0,$srcY=0,$maxWidth=200,$maxHeight=50,$interlace=true)
    {
        // 获取原图信息
         ...
         if($info !== false) {
            ...
            if(function_exists("ImageCopyResampled")) {
            	if ($maxHeight == 1000)
                	...
                	imagecopyresampled($thumbImg, $srcImg, 0, 0, $srcX, $srcY, $maxWidth, $maxHeight, $maxWidth, $maxHeight);
            }
            else
    ...
    // 等比缩放
    static function thumb_db($image,$thumbname,$type='',$srcX=0,$srcY=0,$maxWidth=200,$maxHeight=50,$interlace=true)
    {
    	// 获取原图信息
    	$info  = Image::getImageInfo($image);
    	if($info !== false) {
