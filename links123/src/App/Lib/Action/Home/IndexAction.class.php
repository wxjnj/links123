...
class IndexAction extends CommonAction {
    ...
    private function getAstro($birthday = false){
		...
		if($birthday){
            ...
            $htmlstr="<ul><li style='color:red;font-size:16px;font-weight:bold;'>".$starArr[0]."座&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='color:#000'>".date("m月d日",time())."</span></li>";
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[0]['title']."：&nbsp;&nbsp";
            for($i=0; $i< $astro[0]['rank']; $i++){
                $htmlstr.="<img src='/Public/Images/star.gif'>";
            }
            $htmlstr.="</li>";
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[1]['title']."：&nbsp;&nbsp;";
            for($i=0; $i< $astro[1]['rank']; $i++){
                $htmlstr.="<img src='/Public/Images/star.gif'>";
            }
            $htmlstr.="</li>";
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[2]['title']."：&nbsp;&nbsp;";
            for($i=0; $i< $astro[2]['rank']; $i++){
                $htmlstr.="<img src='/Public/Images/star.gif'>";
            }
            $htmlstr.="</li>";
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[3]['title']."：&nbsp;&nbsp;";
            for($i=0; $i< $astro[3]['rank']; $i++){
                $htmlstr.="<img src='/Public/Images/star.gif'>";
            }
            $htmlstr.="</li>";
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[6]['title']."：&nbsp;&nbsp;".$astro[6]['value'].'</li>';
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[7]['title']."：&nbsp;&nbsp;".$astro[7]['value'].'</li>';
            $htmlstr.="<li style='font-size:13px;font-weight:bold;'>".$astro[8]['title']."：&nbsp;&nbsp;".$astro[8]['value'].'</li></ul>';
			return $htmlstr;
		}
	}
