...
class EnglishMediaViewModel extends ViewModel {
    ...
    public $viewFields = array(
        'englishMedia' => array('id', 'name', 'voice', 'pattern', 'difficulty', 'play_type', 'storage_type', 'path', 'media_source_url', 'media_thumb_img', 'special_recommend', 'created', 'updated', 'status', '_type' => 'LEFT'),
        ...
        'englishMediaRecommend' => array('name' => "recommend_name", '_on' => 'englishMedia.recommend=englishMediaRecommend.id', '_type' => 'LEFT')
    );
