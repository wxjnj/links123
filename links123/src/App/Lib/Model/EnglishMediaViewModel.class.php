...
class EnglishMediaViewModel extends ViewModel {
    ...
    public $viewFields = array(
        'englishMedia' => array('id', 'name', 'pattern', 'difficulty', 'play_type', 'storage_type', 'path', 'media_source_url', 'media_thumb_img', 'recommend', 'special_recommend', 'created', 'updated', 'status', '_type' => 'LEFT'),
