package org.bytearray.micrecorder
{
	...
	public final class MicRecorder extends EventDispatcher
	{
		 ...
		 * 
		 */		
		public function MicRecorder(encoder:IEncoder, ecodec:String=SoundCodec.SPEEX,microphone:Microphone=null, gain:uint=100, rate:uint=44, silenceLevel:uint=0, timeOut:uint=4000)
		{
			_encoder = encoder;
		...
		public function record():void
		{
			...
			_microphone.codec = _ecodec;
			var s:SoundTransform = new SoundTransform();
			s.volume = 0;
			_microphone.soundTransform = s;
